...
import net.leanix.swaggerdemo.api.auth.Authentication;
import net.leanix.swaggerdemo.api.auth.HttpBasicAuth;
import net.leanix.swaggerdemo.api.auth.ApiKeyAuth;
import net.leanix.swaggerdemo.api.auth.OAuth;

public class ApiClient {
  private Map<String, Client> hostMap = new HashMap<String, Client>();
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private boolean debugging = false;
  private String basePath = "https://localhost{{basePath}}";
